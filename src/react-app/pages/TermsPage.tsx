        ...
        <div className={`space-y-8 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Depósito mínimo:</strong> €20 | <strong>Máximo por operação:</strong> €20.000.</li>
              <li>O <strong>levantamento mínimo</strong> é de €20.</li>
              <li>O <strong>levantamento máximo diário</strong> é de €300 e o <strong>levantamento máximo mensal</strong> é de €10.000.</li>
              <li>Todos os levantamentos requerem IBAN válido, nome completo, número do contribuinte e verificação da identidade.</li>
