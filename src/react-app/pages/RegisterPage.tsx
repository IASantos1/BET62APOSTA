          ...
          >
            ...
            <div className={`mt-5 space-y-4 text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              ...
              <div className="rounded-2xl bg-emerald-600/10 px-4 py-3">
                <div className="font-bold text-emerald-500">Acesso imediato</div>
                <div className="mt-1">Depois do registo, a sessão entra diretamente sem abrir a Home por trás.</div>
              </div>
            </div>

            <div className={`mt-6 border-t pt-4 text-sm ${darkMode ? 'border-gray-800 text-gray-400' : 'border-gray-200 text-gray-500'}`}>
              Já tem conta?{' '}
